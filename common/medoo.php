 ...
 *
 * @wangjy 修改如下：
 * 增加PDO事务:beginTransaction/commit/rollBack
 * query exec select insert update delete replace get has count max min avg sum 方法各增加直接输出 sql 语句的方法-debug
...
class medoo
{
    ...
    {
        $this->debug = true;
        echo $this->insert($table, $join, $columns, $where);
    }
    ...
    {
        $this->debug = true;
        echo $this->update($table, $join, $columns, $where);
    }
    ...
    {
        $this->debug = true;
        echo $this->replace($table, $columns, $search = null, $replace = null, $where = null);
    }
    ...
    {
        $this->debug = true;
        echo $this->get($table, $columns, $where = null);
    }
    ...
    public function _has($table, $join, $where = null)
    {
        $this->debug = true;
        echo $this->has($table, $join, $where = null);
    }
    ...
    public function _count($table, $join = null, $column = null, $where = null)
    {
        $this->debug = true;
        echo $this->count($table, $join = null, $column = null, $where = null);
    }
    ...
    public function _max($table, $join, $column = null, $where = null)
    {
        $this->debug = true;
        echo $this->max($table, $join, $column = null, $where = null);
    }
    ...
    public function _min($table, $join, $column = null, $where = null)
    {
        $this->debug = true;
        echo $this->min($table, $join, $column = null, $where = null);
    }
    ...
    public function _avg($table, $join, $column = null, $where = null)
    {
        $this->debug = true;
        echo $this->avg($table, $join, $column = null, $where = null);
    }
    ...
    public function _sum($table, $join, $column = null, $where = null)
    {
        $this->debug = true;
        echo $this->sum($table, $join, $column = null, $where = null);
    }
